"""
send_email.py — Envía el reporte HTML por correo usando SendGrid
"""
      ...
      <div style="padding:24px 28px">
        ...
        <div style="background:#f8fafc;border-radius:8px;padding:16px;margin:16px 0;border:1px solid #e5e7eb">
          ...
          <ul style="color:#374151;font-size:13px;margin:0;padding-left:18px;line-height:1.8">
            <li>Comparativo volumetría y SLA 2025 vs 2026</li>
        ...
        <p style="color:#374151;font-size:13px">Abre el archivo adjunto <strong>{nombre_archivo}</strong> en tu navegador para ver el dashboard interactivo.</p>
        <div style="margin-top:20px;padding-top:16px;border-top:1px solid #e5e7eb">
          <p style="font-size:11px;color:#9ca3af;margin:0">Este reporte se genera automáticamente cada lunes. Datos extraídos de ServiceNow.</p>
        </div>
      </div>
    </div>
    </body></html>
